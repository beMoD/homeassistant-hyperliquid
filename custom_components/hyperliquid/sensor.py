...
from .const import (
    ...
    SENSOR_MAX_DRAWDOWN_24H,
    SENSOR_MAX_DRAWDOWN_30D,
    SENSOR_MAX_DRAWDOWN_7D,
    SENSOR_MAX_DRAWDOWN_ALL_TIME,
    SENSOR_STAKING_BALANCE,
    SENSOR_STAKING_VALUE,
    SENSOR_TRADING_EQUITY,
    ...
    SENSOR_FUNDING_30D,
    SENSOR_MARGIN_USED,
    SENSOR_NON_PERP_PNL_24H,
    SENSOR_NON_PERP_PNL_30D,
    SENSOR_NON_PERP_PNL_7D,
    SENSOR_NON_PERP_PNL_ALL_TIME,
    ...
    SENSOR_PERP_PNL_30D,
    SENSOR_PERP_PNL_7D,
    SENSOR_PERP_PNL_ALL_TIME,
    SENSOR_PERP_VOLUME_24H,
    SENSOR_PERP_VOLUME_30D,
    SENSOR_PERP_VOLUME_7D,
    SENSOR_PERP_VOLUME_ALL_TIME,
    SENSOR_PNL_24H,
    SENSOR_PNL_30D,
    SENSOR_PNL_7D,
    SENSOR_PNL_ALL_TIME,
...
ACCOUNT_SENSORS: tuple[HyperliquidSensorEntityDescription, ...] = (
    HyperliquidSensorEntityDescription(
        # Hyperliquid's "Total Equity" — spot, perps, vaults and staking
    ...
    HyperliquidSensorEntityDescription(
        key=SENSOR_TRADING_EQUITY,
        name="Trading Equity",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.trading_equity,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_STAKING_BALANCE,
        name="Staking Balance",
        native_unit_of_measurement=TOKEN_HYPE,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=4,
        value_fn=lambda data: data.staking_balance,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_STAKING_VALUE,
        name="Staking Value",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.staking_value,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_MAX_DRAWDOWN_24H,
        name="Max Drawdown 24h",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        value_fn=lambda data: data.max_drawdown_24h,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_MAX_DRAWDOWN_7D,
        name="Max Drawdown 7d",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        value_fn=lambda data: data.max_drawdown_7d,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_MAX_DRAWDOWN_30D,
        name="Max Drawdown 30d",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        value_fn=lambda data: data.max_drawdown_30d,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_MAX_DRAWDOWN_ALL_TIME,
        name="Max Drawdown All Time",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        value_fn=lambda data: data.max_drawdown_all_time,
    ),
    ...
    # Perp-only P&L. Cut to the exact window, so these do not have to match
    # the pnl_* sensors above, which span a whole portfolio period (the month
    # period covers ~30.8 days, not 30).
    HyperliquidSensorEntityDescription(
        key=SENSOR_PERP_PNL_24H,
        name="Perp PnL 24h",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.perp_pnl_24h,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_PERP_PNL_7D,
        name="Perp PnL 7d",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.perp_pnl_7d,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_PERP_PNL_10D,
        name="Perp PnL 10d",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.perp_pnl_10d,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_PERP_PNL_14D,
        name="Perp PnL 14d",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.perp_pnl_14d,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_PERP_PNL_20D,
        name="Perp PnL 20d",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.perp_pnl_20d,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_PERP_PNL_21D,
        name="Perp PnL 21d",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.perp_pnl_21d,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_PERP_PNL_28D,
        name="Perp PnL 28d",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.perp_pnl_28d,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_PERP_PNL_30D,
        name="Perp PnL 30d",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.perp_pnl_30d,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_PERP_PNL_ALL_TIME,
        name="Perp PnL All Time",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.perp_pnl_all_time,
    ),
    # Spot and vault share, as total minus perp over the same window
    HyperliquidSensorEntityDescription(
        key=SENSOR_NON_PERP_PNL_24H,
        name="Non-Perp PnL 24h",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.non_perp_pnl_24h,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_NON_PERP_PNL_7D,
        name="Non-Perp PnL 7d",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.non_perp_pnl_7d,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_NON_PERP_PNL_30D,
        name="Non-Perp PnL 30d",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.non_perp_pnl_30d,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_NON_PERP_PNL_ALL_TIME,
        name="Non-Perp PnL All Time",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.non_perp_pnl_all_time,
    ),
    # Trading volume — total, then the perp share
    HyperliquidSensorEntityDescription(
        key=SENSOR_VOLUME_24H,
        name="Volume 24h",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.volume_24h,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_VOLUME_7D,
        name="Volume 7d",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.volume_7d,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_VOLUME_30D,
        name="Volume 30d",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.volume_30d,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_VOLUME_ALL_TIME,
        name="Volume All Time",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.volume_all_time,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_PERP_VOLUME_24H,
        name="Perp Volume 24h",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.perp_volume_24h,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_PERP_VOLUME_7D,
        name="Perp Volume 7d",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.perp_volume_7d,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_PERP_VOLUME_30D,
        name="Perp Volume 30d",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.perp_volume_30d,
    ),
    HyperliquidSensorEntityDescription(
        key=SENSOR_PERP_VOLUME_ALL_TIME,
        name="Perp Volume All Time",
        native_unit_of_measurement=CURRENCY_USD,
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        suggested_display_precision=2,
        value_fn=lambda data: data.perp_volume_all_time,
    ),
